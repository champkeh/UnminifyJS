(() => {
  ...
  var e = (t, a) => (e = Object.setPrototypeOf || {
    __proto__: []
  ...
  function a(e, t, a, n) {
    return new (a || (a = Promise))((r, o) => {
      ...
      function c(e) {
        var t;
        e.done ? r(e.value) : (t = e.value, t instanceof a ? t : new a(e => {
          e(t);
        })).then(i, l);
      }
  ...
  var r;
  var o = -1 !== (r = navigator.appVersion).indexOf("Win") ? "Windows" : -1 !== r.indexOf("Mac") ? "MacOS" : -1 !== r.indexOf("X11") || -1 !== r.indexOf("Linux") ? "Linux" : "Unknown OS";
  var i = navigator.userAgent.toLowerCase();
  var l = "MacOS" === o;
  var c = "Windows" === o;
  var h = "Linux" === o;
  var M = (i.indexOf("firefox"), /^((?!chrome|android).)*safari/i.test(i));
  /android/i.test(i);
  var s = new WeakMap();
  ...
  var v = (() => {
    ...
    return e.prototype.addProp = function (e, t, a, n) {
      return undefined === n && (n = null), null !== t && (this.from[e] = t), null !== a && (this.to[e] = a), null !== n && (this.end[e] = n), this;
    }, e;
  })();
  ...
  function d(e, t) {
    var a = s.get(e);
    s.delete(e);
    a && (e.style.transition = "", u(e, a.props.end), a.win.clearTimeout(a.timer), e.removeEventListener("transitionend", a.fn), t || a.complete && a.complete());
  }
  var p = null;
  function m(e, t, a) {
    d(e);
  ...
  function b(e) {
    return H && Date.now() - H.t < 1000 /* 1e3 */ && (Math.abs(e.clientX - H.sx) < 5 && Math.abs(e.clientY - H.sy) < 5 || Math.abs(e.clientX - H.ex) < 5 && Math.abs(e.clientY - H.ey) < 5);
  }
  var w = {
    isDesktop: false,
    isMobile: false,
  ...
  var Z = "0.0.0";
  k(e => {
    A = e.ipcRenderer.sendSync("is-dev");
    Z = process.versions.electron;
    parseInt(Z.split(".")[0]);
    w.resourcePathPrefix = e.ipcRenderer.sendSync("file-url");
  });
  var x = A;
  x || k(e => {
    try {
      e.deprecate.setHandler(() => {});
    } catch (e) {}
  });
  var E = "https://" + [String.fromCharCode(97, 112, 105), "obsidian", "md"].join(".");
  x && (E = "http://127.0.0.1:3000");
  var z = "obsidian-account";
  var S = window.fetch;
  ...
  function P(e, t, r, o) {
    return a(this, undefined, Promise, function () {
      var a;
      return n(this, n => {
        switch (n.label) {
          case 0:
            return [4, T("/user/signin", {
              email: t,
              password: r,
              mfa: o
            })];
  ...
  let R = {
    get(e, t, a) {
      if (e instanceof IDBTransaction) {
        ...
        if ("store" === t) return a.objectStoreNames[1] ? undefined : a.objectStore(a.objectStoreNames[0]);
      }
      return _(e[t]);
    },
    set: (e, t, a) => (e[t] = a, true),
  ...
  function U(e) {
    return "function" == typeof e ? K(e) : (e instanceof IDBTransaction && (e => {
      if (N.has(e)) return;
  ...
  function _(e) {
    if (e instanceof IDBRequest) return (e => {
      const t = new Promise((t, a) => {
        const n = () => {
  ...
  function ee(e) {
    Object.keys(localStorage).filter(e).forEach(e => localStorage.removeItem(e));
  }
  R = (e => ({
    ...e,
    get: (t, a, n) => Q(t, a) || e.get(t, a, n),
    has: (t, a) => !!Q(t, a) || e.has(t, a)
  }))(R);
  var te = "language";
  var ae = "en";
  ...
  function ce(e) {
    return e.replace(/[A-Z]/g, e => "-" + e.toLowerCase()).replace(/_[0-9]/g, e => "-" + e.substring(1));
  }
  i18next.init({
    fallbackLng: ae,
    ns: [ie],
  ...
  var se = localStorage.getItem(te);
  if (se) {
    Me = a(undefined, undefined, undefined, function () {
      var e;
      var t;
      var a;
      var r;
      ...
      return n(this, n => {
        switch (n.label) {
          ...
          case 1:
            return n.sent(), [2];
          case 2:
            return r = (a = JSON).parse, [4, ajaxPromise({
              url: "/i18n/" + se + ".json"
            })];
          case 3:
    ...
    try {
      ...
      oe.hasOwnProperty(ve) && (ve = oe[ve]);
      window.moment.locale(ve);
    } catch (e) {}
  }
  ...
  x && (window.i18nGenBundles = () => {
    if (w.isDesktopApp) {
      var e = window.require("original-fs");
      var t = electron.ipcRenderer.sendSync("resources");
      for (var a in ne) if (ne.hasOwnProperty(a)) {
        ...
        try {
          if (e.existsSync(n)) {
            ...
            var o = JSON.parse(r);
            var i = le(he, o);
            var l = JSON.stringify(i, null, "\t");
            e.writeFileSync(n, l, "utf8");
            console.log("Saved bundle for", a);
          }
        } catch (e) {
  ...
  var ue = function e(t, a) {
    ...
    return new Proxy(a, {
      get: function (a, r) {
        return n.hasOwnProperty(r) ? n[r] : n[r] = e(t + ce(r) + ".", (e, a) => String.isString(e) ? i18next.t(t + ce(r) + "." + e, a) : i18next.t(t + ce(r), e));
      }
    });
      ...
      e.addEventListener("touchstart", n => {
        if (!(n.touches.length > 1)) {
          ...
          if ("stylus" !== r.touchType) {
            var o = r.clientX;
            var i = r.clientY;
            var l = document.elementFromPoint(o, i);
  ...
  var me = (() => {
    ...
    return e.prototype.load = function () {
    ...
    }, e.prototype.onload = () => {}, e.prototype.unload = function () {
      if (this._loaded) {
        this._loaded = false;
    ...
    }, e.prototype.onunload = () => {}, e.prototype.addChild = function (e) {
      ...
      this.register(() => e.e.offref(e));
    }, e.prototype.registerDomEvent = function (e, t, a, n) {
      e.addEventListener(t, a, n);
      this.register(() => e.removeEventListener(t, a, n));
    }, e.prototype.registerScopeEvent = function (e) {
      this.register(() => e.scope.unregister(e));
    }, e.prototype.registerInterval = function (e) {
      return this.register(() => clearInterval(e)), e;
    }, e;
  })();
  const fe = {
  ...
  function Ve(e) {
    var t = e[0];
    if (0 === t) return ye("line", {
      x1: e[1],
      y1: e[2],
      x2: e[3],
      y2: e[4]
    });
    if (1 === t) return ye("circle", {
      cx: e[1],
      cy: e[2],
      r: e[3]
    });
    if (2 === t) return ye("polyline", {
      points: e[1]
    });
    if (3 === t) return ye("polygon", {
      points: e[1]
    });
    if (4 === t) return ye("ellipse", {
      cx: e[1],
      cy: e[2],
      rx: e[3],
      ry: e[4]
  ...
  function Ae(e, t) {
    if (!ke.hasOwnProperty(e)) {
      var a = t();
      if (!a) return null;
      a.classList.add("svg-icon", e);
      ke[e] = a;
    }
    return ke[e].cloneNode(true);
  }
  function Ze(e, t) {
    var a = e.firstChild;
    if (!(a && a.instanceOf(SVGSVGElement) && a.classList.contains(t))) {
      a && e.removeChild(a);
      var n = (e => e.startsWith("lucide-") ? Ae(e, () => {
        var t = e.substring("lucide-".length);
        return fe.hasOwnProperty(t) ? He(fe[t]) : null;
      }) : Ce.hasOwnProperty(e) ? Ae(e, () => {
        var t = ye("svg", Le);
        return t.innerHTML = Ce[e], t;
      }) : we.hasOwnProperty(e) ? Ae(e, () => {
        var t = ye("svg", ge);
        return t.innerHTML = we[e], t;
      }) : (be.hasOwnProperty(e) && (e = be[e]), fe.hasOwnProperty(e) ? Ae("lucide-" + e, () => He(fe[e])) : null))(t);
      n && e.appendChild(n);
    }
  }
  function xe(e, t) {
    ...
    r && (r.removeAllRanges(), r.addRange(n), w.isMobile && (e => {
      var t;
      var a = Date.now();
  ...
  var Be = (() => {
      ...
      return e.prototype.register = function (e, t, a) {
        var n = {
          scope: this,
          modifiers: e ? Ne.compileModifiers(e) : null,
          key: t,
          func: a
        };
  ...
  var Ne = ((e => {
    ...
    t(a, e);
    a.prototype.handleKey = function (t, a) {
      var n = this.cb();
    ...
    return e.init = () => (e.global || (e.global = new e()), e.global), e.prototype.getRootScope = function () {
      ...
      if (a) {
        ...
        if (!e.isModifierKey(n)) {
          ...
          return false === a.handleKey(t, o) ? (t.preventDefault(), t.stopPropagation(), false) : undefined;
        }
      }
      ...
      if (a && a.tabFocusContainerEl) {
        var n = a.tabFocusContainerEl,
          r = e.targetNode;
        r && r !== activeDocument.body && r.instanceOf(Element) && !n.contains(r) && setTimeout(() => {
          if (!(t.scope !== a || (o = n.querySelector(["a[href]", "button", "input", "select", "textarea", '[contenteditable]:not([contenteditable="false"])', "[tabindex]"].map(e => e + ':not([disabled]):not([tabindex="-1"])').join(","))) && (o.instanceOf(HTMLElement) || o.instanceOf(SVGElement)) && (o.focus(r), o))) {
    ...
    }, e.compileModifiers = e => e.map(e => "Mod" === e ? "MacOS" === o ? "Meta" : "Ctrl" : e).sort().join(","), e.decompileModifiers = e => e.split(",").map(e => "MacOS" === o && "Meta" === e || "MacOS" !== o && "Ctrl" === e ? "Mod" : e).filter(e => e), e.isModifierKey = e => "Control" === e || "Alt" === e || "Shift" === e || "OS" === e || "Meta" === e, e.prototype.matchModifiers = function (e) {
      return this.modifiers === e;
    }, e.prototype.hasModifier = function (t) {
      return e.decompileModifiers(this.modifiers).contains(t);
    }, e.isModifier = (e, t) => "Ctrl" === t ? e.ctrlKey : "Meta" === t ? e.metaKey : "Alt" === t ? e.altKey : "Shift" === t ? e.shiftKey : "Mod" === t && ("MacOS" === o ? e.metaKey : e.ctrlKey), e.isMatch = (e, t) => {
      var a = e.modifiers,
        n = e.key;
      return (null === a || a === t.modifiers) && (!n || n === t.vkey || !(!t.key || n.toLowerCase() !== t.key.toLowerCase()));
    }, e.isModEvent = t => !!t && ((e => (e.instanceOf(MouseEvent) || e.instanceOf(PointerEvent)) && 1 === e.button)(t) ? "tab" : !!e.isModifier(t, "Mod") && (e.isModifier(t, "Alt") ? e.isModifier(t, "Shift") ? "window" : "split" : "tab")), e;
  })());
  ...
  var Fe = (() => {
    ...
    return e.prototype.setTitle = function (e) {
      ...
      this.submenu || (this.dom.addClass("has-submenu"), this.submenu = new Re(), Ze(this.dom.createDiv("menu-item-icon mod-submenu"), "lucide-chevron-right"), this.onClick(e => e.preventDefault()));
      return this.submenu;
  ...
  var Re = (e => {
      function a() {
        ...
        t.unloading = false;
        t.useNativeMenu = a.useNativeMenu;
        t.items = [];
        t.sections = [];
        t.submenuConfigs = {};
        t.selected = -1;
        t.openSubmenuSoon = ((e, t, a) => {
          undefined === t && (t = 0);
          undefined === a && (a = false);
          var n = null,
            r = null,
            ...
            M = function(...args) {
              for (var e = [], c = 0; c < args.length; c++) e[c] = args[c];
              return r = this, o = e, n ? a && (i = Date.now() + t) : (l = activeWindow, n = l.setTimeout(h, t)), M;
            };
          return M.cancel = () => (n && (l.clearTimeout(n), n = null), M), M.run = () => {
            if (n) return l.clearTimeout(n), n = null, c();
          }, M;
        })(t.openSubmenu.bind(t), 250, true);
        t.scope = new Be(Ne.global.getRootScope());
        var n = t.dom = createDiv("menu"),
          r = t.bgEl = createDiv("suggestion-bg");
        if (r.style.opacity = "0", r.addEventListener("mousedown", e => e.preventDefault()), n.addEventListener("mousedown", e => {
            ...
            e.registerCallback({
              move: function (t, a) {
                ...
                var o = n.offsetHeight,
                  i = Math.clamp((a - e.startY) / o, 0, 1);
                n.style.transform = "translateY(".concat(i * o, "px)");
                r.style.opacity = String(1 - i);
              },
              cancel: function () {
              ...
              finish: function (a, o, i) {
                ...
                var l,
                  c = n.offsetHeight,
                  h = Math.clamp((o - e.startY) / c, 0, 1);
                i < c / 2 ? (m(n, new v({
                  duration: 200 * (l = h)
                }).addProp("transform", null, "translateY(0)", "")), m(r, new v({
                  duration: 150 * l,
                  fn: "linear"
                }).addProp("opacity", null, "1", ""))) : (m(n, new v({
                  duration: 100 * (l = 1 - h),
                  fn: "ease-out"
                }).addProp("transform", null, "translateY(".concat(c, "px)"), ""), () => {
                  t.dom.detach();
                  t.hide();
                }), m(r, new v({
                  duration: 150 * l,
      ...
      return t(a, e), a.prototype.onload = function () {
        ...
        var t;
        if (this.dom.contains(e) || (null === (t = this.parentEl) || undefined === t ? undefined : t.contains(e))) return true;
        for (var a = this.parentMenu; a;) {
          if (a.dom.contains(e)) return true;
          a = a.parentMenu;
        }
        for (var n = this.currentSubmenu; n;) {
          if (n.dom.contains(e)) return true;
          n = n.currentSubmenu;
        }
        return false;
      }, a.prototype.sort = function () {
        for (var e = this, t = e.items, a = e.sections, n = e.submenuConfigs, r = {
            "": []
          }, o = 0, i = t; o < i.length; o++) {
          var l = "";
          (y = i[o]) instanceof Fe && (l = y.section);
          "" === l || a.contains(l) || a.push(l);
          var c = r[l];
          r.hasOwnProperty(l) || (c = r[l] = []);
          c.push(y);
        }
        t = [];
            ...
            if (p.length > 1 && !w.isMobile) {
              ...
              if (m) {
                if (M && m === s) M.items.push(new je(this));else {
                  ...
                  t.push(y);
                  y.setTitle(g.title);
                  g.icon && y.setIcon(g.icon);
                  g.disabled && y.setDisabled(true);
                  M = y.setSubmenu();
                  s = m;
                }
        ...
        this.items = t;
        this.dom.setChildrenInPlace(t.map(e => e.dom));
      }, a.prototype.addSections = function (e) {
        var t = this.sections;
        e = e.filter(e => !t.contains(e));
        var a = t.indexOf("");
        return -1 === a && (a = t.length), t.splice(...function (e, t, a) {
        ...
        var t = this;
        return this.parentEl && this.parentEl.removeClass("has-active-menu"), this.parentEl = e, ((e, t, a) => {
          var n = e.doc,
            r = setInterval(() => {
        ...
        if (this.parentEl && this.parentEl.addClass("has-active-menu"), this.sort(), !w.isDesktopApp || !this.useNativeMenu) {
          ...
          if (n.appendChild(M), n.appendChild(s), w.isPhone) {
            ...
            var b = M.style,
              C = H - d >= 0;
            !(V + d <= f) || e.left && C ? b.left = Math.max(0, H - d) + "px" : b.left = V + "px";
            b.top = o + p > g ? Math.max(y, o - p + 2) + "px" : o + 2 + "px";
            (h = M).addEventListener("mousemove", e => {
              var t = h.clientHeight,
                a = h.scrollHeight;
              if (a > t) {
        ...
        var L = t.win,
          k = e => {
            for (var t = [], a = e => {
                if (e instanceof Fe) {
                  ...
                  e.submenu && (e.submenu.sort(), a.submenu = k(e.submenu.items));
                  t.push(a);
                } else e instanceof je && t.push({
                  type: "separator"
                });
          ...
          A = k(this.items),
          Z = L.electron.remote.Menu.buildFromTemplate(A);
        Z.on("menu-will-close", () => a.hide());
        var x = L.electron.remote.getCurrentWebContents(),
          E = Math.pow(1.2, x.getZoomLevel());
        Z.popup({
          x: Math.round(r * E),
          y: Math.round(o * E),
          window: L.electron.remote.getCurrentWindow()
        });
        ...
        this.unloading = true;
        e = this;
        pe.contains(e) && pe.remove(e);
        this.unselect();
        this.closeSubmenu();
        this.parentMenu && this.parentMenu.currentSubmenu === this ? (We === this && (We = this.parentMenu), this.parentMenu.currentSubmenu = null) : We = null;
        ...
        for (var t = this.items, a = this.selected - 1, n = 0; n < t.length;) {
          var r = t[a];
          if (r && r instanceof Fe && !r.disabled) return this.select(a), false;
          --a < 0 && (a = t.length - 1);
          n++;
        }
        return false;
        ...
        return e.preventDefault(), this.parentMenu && this.hide(), false;
      }, a.prototype.onArrowRight = function (e) {
        e.preventDefault();
        var t = this.items[this.selected];
        return t instanceof Fe && t.submenu && (this.openSubmenu(t), this.currentSubmenu && this.currentSubmenu.select(0)), false;
      }, a.prototype.onEnter = function (e) {
        var t = this.items[this.selected];
        return t && t instanceof Fe && (t.handleEvent(e), this.hide()), false;
        ...
        if (!e.disabled) {
          ...
          if (t) {
            t.parentMenu = this;
            this.currentSubmenu = t;
            var o = getComputedStyle(this.dom),
              i = parseFloat(o.paddingTop) + parseFloat(o.borderTopWidth),
  ...
  function Qe(e) {
    ...
    var r = 750;
    e.hasAttribute("data-tooltip-delay") && (r = parseInt(e.getAttribute("data-tooltip-delay") || ""), isNaN(r) && (r = 750));
    tt(e, t, {
      placement: a,
      classes: n,
      delay: r
  ...
  function tt(e, t, a) {
    var n = Date.now();
    var r = (a = a || {}).placement;
    var o = undefined === r ? "bottom" : r;
    var i = a.classes;
    var l = undefined === i ? [] : i;
    var c = a.gap;
    var h = undefined === c ? 8 : c;
    var M = a.horizontalParent;
    var s = a.delay;
    var v = undefined === s ? 0 : s;
    if (v > 0 && (Ke || n > et + 100)) return Ge(), a.delay = 0, void (_e = window.setTimeout(() => tt(e, t, a), v));
    if (t) {
      var u = e.doc;
      ...
      Ke && Ue === e ? Ke.setText(t) : (at(), Ke = createDiv({
        cls: "tooltip",
        text: t
      }));
      var V = Ke.createDiv("tooltip-arrow");
      var H = 0;
      var b = 0;
      "bottom" === o ? (H = p + g + h, b = m + f / 2) : "right" === o ? (H = p + g / 2, b = m + f + h, l.push("mod-right")) : "left" === o ? (H = p + g / 2, b = m - h, l.push("mod-left")) : "top" === o && (H = p - h - 5, b = m + f / 2, l.push("mod-top"));
      Ke.addClasses(l);
      Ke.style.top = "0px";
      Ke.style.left = "0px";
      Ke.style.width = "";
      Ke.style.height = "";
      Ke.parentNode || u.body.appendChild(Ke);
      var w = Ke.getBoundingClientRect();
      var C = ["bottom", "top"].contains(o) ? w.width / 2 : w.width;
      var L = "right" === o || "left" === o ? w.height / 2 : w.height;
      "left" === o ? b -= C : "top" === o && (H -= L);
      var k = u.body.clientHeight;
      var A = u.body.clientWidth;
      if (H + L > k && (H = k - L - h), H = Math.max(H, h), "top" === o || "bottom" === o) {
        if (b + C > A) {
          b -= Z = b + C + h - A;
          V.style.left = "initial";
          V.style.right = C - Z - h / 2 + "px";
        } else if (b - h - C < 0) {
          var Z;
          b += Z = -(b - h - C);
          V.style.right = "initial";
          V.style.left = C - Z - h / 2 + "px";
        }
        b = Math.max(b, h);
      }
      Ke.style.top = H + "px";
      Ke.style.left = b + "px";
      Ke.style.width = w.width + "px";
      Ke.style.height = w.height + "px";
      Ue = e;
    }
  }
  function at() {
    Ge();
    Ke && (et = Date.now(), Ke.detach(), Ke = null, Ue = null);
  }
  function nt(e, t) {
    var a = t || {};
    var n = a.placement;
    var r = a.classes;
    var o = a.delay;
    n && "bottom" !== n && e.setAttribute("data-tooltip-position", n);
  ...
  var ot = (() => {
    function e(e, t) {
      this.eWin = e;
      this.win = t;
      var a = this.isMac = "darwin" === window.process.platform;
      var n = t.document;
      var r = n.body;
      ...
      t.addEventListener("resize", this.updateStatus.bind(this));
      ...
      if (this.updateStatus(), this.updateTitle(), !a) {
        if (e.minimizable) {
          ...
          c.innerHTML = '<svg aria-hidden="false" width="10" height="10" viewBox="0 0 12 12"><rect fill="currentColor" width="10" height="1" x="1" y="6"></rect></svg>';
          Me.then(() => {
    ...
    return e.prototype.updateTitle = function () {
      ...
      var t = this.eWin;
      if (!e.closed) {
        var a = t.webContents.getZoomFactor();
        ...
        if (n.toggleClass("is-fullscreen", t.isFullScreen()), n.toggleClass("is-maximized", t.isMaximized()), n.style.setProperty("--zoom-factor", String(a)), this.isMac && "hidden" === e.titlebarStyle) {
          var r = 40;
          var o = getComputedStyle(n).getPropertyValue("--header-height");
          o && (r = parseFloat(o));
          (isNaN(r) || 0 === r) && (r = 40);
          var i = Math.floor(r * a / 2 - 8);
          i < -5 && (i = 0);
          t.setTrafficLightPosition({
            x: i + 2,
            y: i
          });
        }
  ...
  var it = createDiv("notice-container");

  var lt = (() => {
    function e(e, t) {
      undefined === t && (t = 4000 /* 4e3 */);
      var a = this;
      activeDocument.body.appendChild(it);
      var n = this.noticeEl = it.createDiv({
        cls: "notice",
        text: e
      });
      w.isMobile ? m(n, new v().addProp("marginBottom", -n.offsetHeight + "px", "0", "")) : m(n, new v().addProp("transform", "translateX(350px)", "", ""));
      t && setTimeout(() => a.hide(), t);
      n.addEventListener("click", () => a.hide());
    }
    return e.prototype.setMessage = function (e) {
      ...
      setTimeout(() => {
        var t = e.noticeEl;
        if (w.isMobile) m(t, new v().addProp("opacity", null, "0", ""), () => {
          t.detach();
          0 === it.childElementCount && it.detach();
        });else {
          var a = getComputedStyle(t),
            n = -(t.offsetHeight + parseInt(a.marginBottom)) + "px";
          m(t, new v().addProp("marginTop", "0", n, ""), () => {
            t.detach();
            0 === it.childElementCount && it.detach();
          });
        }
  ...
  function ht(e, t, a) {
    return a < 0 && (a += 1), a > 1 && (a -= 1), a < 1 / 6 ? e + 6 * (t - e) * a : a < 0.5 /* .5 */ ? t : a < 2 / 3 ? e + (t - e) * (2 / 3 - a) * 6 : e;
  }
  function Mt(e) {
    var t;
    var a;
  ...
  var ut = (() => {
      function e(e) {
        ...
        var t = this.settingEl = e.createDiv("setting-item"),
          a = this.infoEl = t.createDiv("setting-item-info");
        this.nameEl = a.createDiv("setting-item-name");
        this.descEl = a.createDiv("setting-item-description");
  ...
  var pt = (e => {
    ...
    return t(a, e), a.prototype.registerOptionListener = function (e, t) {
      var a = this;
      return e[t] = e => (undefined !== e && a.setValue(e), a.getValue()), this;
    }, a;
  })(dt);
  ...
  var mt = (e => {
    function a(t) {
      ...
      return (a.buttonEl = t.createEl("button")).addEventListener("click", e => {
  ...
  var ft = (e => {
    function a(t) {
      ...
      return Ze(n, "lucide-settings"), n.addEventListener("click", () => {
  ...
  var gt = (e => {
    function a(t) {
      var a = e.call(this) || this;
      return a.on = false, (a.toggleEl = t.createDiv("checkbox-container", e => {
        e.createEl("input", {
          attr: {
            type: "checkbox",
            tabIndex: 0
    ...
    return t(a, e), a.prototype.setDisabled = function (t) {
      ...
      var t;
      return this.on = e, this.toggleEl.toggleClass("is-enabled", e), null === (t = this.changeCallback) || undefined === t || t.call(this, e), this;
  ...
  var Ht = (e => {
    function a(t) {
      var a = this,
        n = t.createDiv("search-input-container"),
        r = n.createEl("input", {
          type: "search",
          attr: {
            enterkeyhint: "search"
      ...
      return (a = e.call(this, r) || this).containerEl = n, a.clearButtonEl = n.createDiv("search-input-clear-button", e => {
  ...
  var Ct = (e => {
    function a(t) {
      var a = e.call(this) || this;
      return a.selectEl = t.createEl("select", "dropdown"), a.selectEl.addEventListener("change", () => {
        var e = a.changeCallback;
        e && e(a.getValue());
      }), a;
    }
    return t(a, e), a.prototype.setDisabled = function (t) {
      ...
      for (var t in e) e.hasOwnProperty(t) && this.selectEl.createEl("option", {
        value: t,
        text: e[t]
      });
      return this;
  ...
  var Lt = (e => {
    function a(t) {
      var a = e.call(this) || this;
      return a.progressBar = t.createDiv("setting-progress-bar", e => {
  ...
  var kt = (e => {
    function a(t) {
      var a = e.call(this) || this;
      a.dynamicTooltip = false;
      var n = a.sliderEl = t.createEl("input", {
        type: "range",
        cls: "slider"
      });
      return n.addEventListener("input", () => {
        var e = a.changeCallback;
        e && e(a.getValue());
        a.dynamicTooltip && a.showTooltip();
    ...
    return t(a, e), a.prototype.setDisabled = function (t) {
      ...
      var e = this.sliderEl;
      return e.addEventListener("mouseenter", this.showTooltip.bind(this)), e.addEventListener("mouseleave", at), this.dynamicTooltip = true, this;
    }, a.prototype.showTooltip = function () {
      tt(this.sliderEl, this.getValuePretty(), {
        placement: "top"
      });
    }, a.prototype.onChange = function (e) {
      return this.changeCallback = e, this;
  ...
  var At = (e => {
    function a(t) {
      var a = e.call(this) || this;
      return a.colorPickerEl = t.createEl("input", {
        type: "color"
      }), a.colorPickerEl.addEventListener("change", () => {
        var e = a.changeCallback;
        e && e(a.getValue());
      }), a;
    }
    return t(a, e), a.prototype.setDisabled = function (t) {
      ...
      return (e => {
        ...
        if (i == l) r = o = 0;else {
          var h = i - l;
          switch (o = c > 0.5 /* .5 */ ? h / (2 - i - l) : h / (i + l), i) {
            case t:
              r = (a - n) / h + (a < n ? 6 : 0);
              break;
            case a:
    ...
    if (a) {
      ...
      if (n) {
        ...
        e.parent === e && (e => {
          ...
          e.titlebarStyle = t;
          "native" !== t && (e.frameDom = new ot(e.electronWindow, e), "hidden" === t && e.document.body.addClass("is-hidden-frameless"));
        })(e);
      }
    }
  })(window);
  (e => {
    e || (e = document);
    var t = e.body;
    t.on("mouseover", "[aria-label]", Ye);
    t.on("mouseout", "[aria-label]", Je);
    t.addEventListener("mouseup", at);
  })();
  (e => {
    try {
      var t = "";
      l ? t = "mod-macos" : c ? t = "mod-windows" : h && (t = "mod-linux");
      t && e.body.addClass(t);
    } catch (e) {
      console.error(e);
    }
  ...
  ready(() => a(undefined, undefined, undefined, function () {
    function e(e, t) {
    ...
    function t() {
      ...
      h.sort((e, t) => t.ts - e.ts);
      for (var u = o => {
          var i = f.createDiv("recent-vaults-list-item"),
            l = s.basename(o.path),
            h = s.dirname(o.path),
            u = i.createDiv({
              cls: "recent-vaults-list-item-name",
              text: l
            });
          i.createDiv({
            cls: "recent-vaults-list-item-path",
            text: h
          });
          var d = (e, i) => a(r, undefined, undefined, function () {
            var a, r;
            return n(this, n => e === o.path ? [2] : v.existsSync(e) ? (new lt(c("msg-error-".concat(i, "-exists"))), [2]) : !(a = s.relative(o.path, e)) || a.startsWith("..") || s.isAbsolute(a) ? (r = M.sendSync("vault-move", o.path, e), new lt("EVAULTOPEN" === r ? c("msg-error-".concat(i, "-open")) : r ? c("msg-".concat(i, "-failed")) + " " + r : c("msg-".concat(i, "-success"))), t(), [2]) : (new lt(c.msgErrorNested()), [2]));
          }),
            p = () => {
            ...
            m = r => {
              r.preventDefault();
              new Re().addItem(e => e.setIcon("lucide-folder-open").setTitle(w.isMacOS ? c.optionRevealVaultInExplorerMac() : c.optionRevealVaultInExplorer()).onClick(() => {
                var e;
                e = o.path;
                window.electron && (w.isMacOS ? electron.remote.shell : electron.shell).showItemInFolder(e);
              })).addItem(e => e.setIcon("lucide-edit-3").setTitle(c.optionRenameVault()).onClick(p)).addItem(t => t.setIcon("lucide-send").setTitle(c.optionMoveVault()).onClick(() => {
                var t = e(c.msgMoveSelectDest(), h);
                t && d(s.join(t, l), "move");
              })).addItem(e => e.setIcon("lucide-copy").setTitle(c.optionCopyVaultID()).onClick(() => {
                navigator.clipboard.writeText(o.id);
                new lt(ue.interface.copied_generic());
              })).addItem(e => e.setIcon("lucide-x").setTitle(c.optionRemove()).onClick(() => {
                M.sendSync("vault-remove", o.path) ? function (e) {
                  a(this, undefined, undefined, function () {
                    return n(this, t => {
                      try {
                ...
                }(o.id) : new lt(c.msgErrorRemoveCurrentOpenVault());
                t();
              })).showAtMouseEvent(r);
            };
          i.addEventListener("contextmenu", e => m(e));
          i.createDiv("recent-vaults-list-item-option-button", e => {
            Ze(e, "lucide-more-vertical");
            rt(e, ue.interface.menu.moreOptions());
            e.addEventListener("click", e => m(e));
          });
          i.addEventListener("click", e => {
            if (!e.defaultPrevented) {
              e.preventDefault();
              var t = M.sendSync("vault-open", o.path, false);
              true === t ? window.close() : new lt("".concat(c.msgErrorFailedToOpenVault(), " ").concat(t, "."));
            }
          });
          rt(i, o.path, {
            placement: "right"
    ...
    function r() {
      ...
      J.empty();
      (e => {
        for (var t = createDiv("loader-cube"), a = 1; a <= 9; a++) t.createDiv({
          cls: "sk-cube sk-cube".concat(a)
        });
        e && e.appendChild(t);
      })(J);
      y(H, J, "right", () => a(e, undefined, undefined, function () {
        var e;
        var t;
        var a;
        return n(this, n => {
          switch (n.label) {
            case 0:
              ...
              n.label = 1;
            case 1:
              return n.trys.push([1, 3,, 4]), [4, (r = o.token, T("/vault/list", {
                token: r
              }))];
            case 2:
    ...
    return n(this, w => {
      switch (w.label) {
        ...
        case 1:
          return w.sent(), document.body.addClass("is-focused"), o = new O(), i = ue.plugins.sync, l = ue.setting.account, c = ue.interface.startScreen, h = electron.remote, M = electron.ipcRenderer, setTimeout(() => {
          ...
          }), H = g.createDiv("open-vault-options-container"), b = H.createDiv("open-vault-options mod-open-vault"), C = b.createDiv("quick-start-container u-center-text"), new mt(C).setCta().setButtonText(c.buttonQuickStart()).onClick(() => {
            var e = M.sendSync("get-default-vault-path");
            var t = M.sendSync("vault-open", e, true);
            true === t ? window.close() : new lt("".concat(c.msgErrorFailedToOpenVault(), " ").concat(t, "."));
          }), new ut(b).setName(c.optionCreateVault()).setDesc(c.optionCreateVaultDescription()).addButton(e => e.setButtonText(c.buttonCreateVault()).setCta().onClick(() => {
            E = null;
            z = b;
            q.setName(c.labelCreateLocalVault());
            y(H, S, "right");
          })), new ut(b).setName(c.optionOpenFolderAsVault()).setDesc(c.optionOpenFolderAsVaultDescription()).addButton(t => t.setButtonText(c.buttonOpen()).onClick(() => {
            var t = e(c.optionOpenFolderAsVault());
            if (t) {
              var a = M.sendSync("vault-open", t, false);
              true === a ? window.close() : new lt("".concat(c.msgErrorFailedToOpenVault(), " ").concat(a, "."));
            }
          })), L = new ut(b).setName(c.optionConnectObsidianSync()).setDesc(c.optionConnectObsidianSyncDescription()), o.email && o.token ? L.addButton(e => e.setButtonText(c.buttonSetup()).onClick(() => r())) : L.addButton(e => e.setButtonText(c.buttonSignIn()).onClick(() => {
            y(H, N, "right");
          })), k = localStorage.getItem(te) || ae, Ze((A = new ut(b).addDropdown(e => {
            ...
            e.setValue(k);
            e.onChange(e => {
              e === ae ? localStorage.removeItem(te) : localStorage.setItem(te, e);
              window.location.reload();
            });
          })).nameEl, "help"), rt(A.nameEl, c.optionGetHelp()), A.nameEl.addEventListener("click", () => {
            M.sendSync("help");
          }), A.setClass("mod-change-language"), x = "", E = null, z = b, (S = createDiv("open-vault-options mod-create-vault")).createDiv({
            cls: "back-button"
          }, e => {
            Ze(e, "lucide-arrow-left");
            e.appendText(c.buttonBack());
            e.addEventListener("click", () => {
              y(H, z, "left");
            });
          }), q = new ut(S).setHeading(), new ut(S).setName(c.optionNewVaultName()).setDesc(c.optionNewVaultNameDescription()).addText(e => e.setPlaceholder(c.optionNewVaultName()).then(e => Z = e)), I = new ut(S).setName(c.optionNewVaultLocation()).setDesc(c.optionNewVaultLocationDescription()).addButton(t => t.setButtonText(c.buttonBrowse()).onClick(() => {
            var t = e(c.optionNewVaultLocation());
            t && B(t);
          })), B = e => {
            x = e;
            I.setDesc(createFragment(t => {
              t.appendText(c.labelNewVaultLocationPreview());
              t.createSpan({
                cls: "u-pop",
                text: e
              });
            }));
          }, S.createDiv("u-center-text", e => {
            e.createEl("button", {
              cls: "mod-cta",
              text: c.buttonCreateVault()
            }, e => {
              e.addEventListener("click", () => {
                ...
                if (e) {
                  if (x) {
                    var t = x + "/" + e;
                    try {
                      var a = M.sendSync("vault-open", t, true);
                      if (true === a) return E ? (M.sendSync("vault-message", t, {
                        action: "sync-setup",
                        vault: JSON.stringify(E)
                      }), y(H, b, "left")) : M.sendSync("vault-message", t, {
                        action: "vault-setup"
                      }), void window.close();
                  ...
                  } else new lt(c.msgInvalidFolder());
                } else new lt(c.msgEmptyVaultName());
              });
            });
          }), (N = createDiv("open-vault-options mod-login")).createDiv({
            cls: "back-button"
          }, e => {
            Ze(e, "lucide-arrow-left");
            e.appendText(c.buttonBack());
          ...
          }), F = N.createDiv("message-container", e => {
            ...
            j.setText("");
            F.hide();
          })(), _ = new ut(N).setName(c.optionUserEmail()).addText(e => e.setPlaceholder(c.placeholderYourEmail()).then(e => W = e)), G = new ut(N).setName(c.optionUserPassword()).addText(e => e.setPlaceholder(c.placeholderYourPassword()).then(e => {
            R = e;
            e.inputEl.setAttribute("type", "password");
          })), (Y = new ut(N).setName(l.labelMfaCode()).addText(e => {
            K = e;
            e.inputEl.setAttribute("maxlength", "6");
            e.inputEl.inputMode = "numeric";
          })).settingEl.hide(), new ut(N).addButton(e => e.setButtonText(c.buttonSignIn()).setCta().onClick(() => a(undefined, undefined, undefined, function () {
            var e;
            var t;
            var a;
            var i;
          ...
          }))), J = createDiv("open-vault-options"), $ = e => {
            if (J.empty(), J.createDiv({
              cls: "back-button"
            }, e => {
              Ze(e, "lucide-arrow-left");
              e.appendText(c.buttonBack());
            ...
            }), 0 === e.length) J.createEl("p", {
              text: i.labelNotRemoteVaults()
            });else for (var t = e => {
                var t = createDiv("setting-icon", t => {
                  ("share_uid" in e) && e.share_uid ? (Ze(t, "lucide-users"), rt(t, c.tooltipSharedVault())) : (Ze(t, "vault"), rt(t, c.tooltipOwnVault()));
                });
                new ut(J).setName(e.name).setDesc(c.optionConnectVaultDesc()).addButton(t => t.setButtonText(c.buttonConnect()).onClick(() => {
                  Z.setValue(e.name);
                  q.setName('Create synced local vault for "'.concat(e.name, '"'));
                  z = J;
                  B(M.sendSync("get-documents-path"));
                  E = e;
                  y(H, S, "right");
                })).settingEl.prepend(t);
