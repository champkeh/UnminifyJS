(() => {
    ...
    function e(e, t) {
        ...
        a(e, t), e.prototype = null === t ? Object.create(t) : (M.prototype = t.prototype, new M)
    }

    function t(a, e, t, M) {
        return new (t || (t = Promise))((function (r, h) {
            function o(a) {
                try {
                    l(M.next(a))
                } catch (a) {
    ...
    new WeakMap, function () {
        function a(a) {
            ...
            var e = a || {}, t = e.duration, M = void 0 === t ? 100 : t, r = e.fn, h = void 0 === r ? "ease-in-out" : r;
            this.duration = M, this.fn = h
        }

        a.prototype.addProp = function (a, e, t, M) {
            return void 0 === M && (M = null), null !== e && (this.from[a] = e), null !== t && (this.to[a] = t), null !== M && (this.end[a] = M), this
        }
    }();
    ...
    !function () {
        ...
        a.prototype.add = function (a, e) {
            var t = this.data, M = t[a];
            M || (M = [], t[a] = M), M.contains(e) || M.push(e)
            ...
            var a = this.data, e = 0;
            for (var t in a) a.hasOwnProperty(t) && (e += a[t].length);
            return e
        }
    }();
    (function () {
        ...
        a.prototype.add = function (a, e) {
            ...
            if (t.has(a)) {
                var M = t.get(a);
                M.remove(e), 0 === M.length && t.delete(a)
            }
        }, a.prototype.get = function (a) {
        ...
        a.prototype.add = function (a, e) {
            ...
            if (t.has(a)) {
                var M = t.get(a);
                M.delete(e), 0 === M.size && t.delete(a)
            }
        }, a.prototype.get = function (a) {
            return this.data.get(a)
    ...
    function s(a, e) {
        var t = a.relatedTarget;
        return !t || !e.contains(t)
    }

    /bot|crawl|spider/i.test(navigator.userAgent);
    var v = {sx: 0, sy: 0, ex: 0, ey: 0, t: 0};

    function m(a) {
        return v && Date.now() - v.t < 1e3 && (Math.abs(a.clientX - v.sx) < 5 && Math.abs(a.clientY - v.sy) < 5 || Math.abs(a.clientX - v.ex) < 5 && Math.abs(a.clientY - v.ey) < 5)
    }
    ...
    var g = !1, H = "0.0.0";
    f((function (a) {
        g = a.ipcRenderer.sendSync("is-dev"), H = process.versions.electron, parseInt(H.split(".")[0]), p.resourcePathPrefix = a.ipcRenderer.sendSync("file-url")
    }));
    var V = g;
    V || f((function (a) {
        try {
    ...
    var y = "language", b = {
        ...
        zh: "简体中文",
        "zh-TW": "繁體中文"
    }, L = (Object.keys(b).sort(), {zh: "zh-cn", cz: "cs", no: "nn"}), C = "default";

    function w(a, e) {
        if (String.isString(a)) return null !== e && String.isString(e) ? e : a;
        var t = {};
        for (var M in a) a.hasOwnProperty(M) && (t[M] = w(a[M], e && e[M] || null));
        return t
    }
    ...
    i18next.init({
        ...
        initImmediate: !1,
        interpolation: {
            alwaysFormat: !0, escapeValue: !1, format: function (a, e) {
    ...
    var A = Promise.resolve(), z = localStorage.getItem(y);
    if (z) {
        A = t(void 0, void 0, void 0, (function () {
            var a, e, t, r, h;
            return M(this, (function (M) {
                switch (M.label) {
                    ...
                    case 1:
                        return M.sent(), [2];
                    case 2:
                        return r = (t = JSON).parse, [4, ajaxPromise({url: "/i18n/" + z + ".json"})];
                    case 3:
        ...
        try {
            var x = z.toLowerCase();
            L.hasOwnProperty(x) && (x = L[x]), window.moment.locale(x)
        } catch (a) {
        }
    }
    window.selectLanguageFileLocation = function () {
        if (p.isDesktopApp) {
            ...
            if (a.length > 0) {
                var e = a[0];
                localStorage.setItem(y, e), location.reload()
            }
        }
    }, V && (window.i18nGenBundles = function () {
        if (p.isDesktopApp) {
            var a = window.require("original-fs"), e = electron.ipcRenderer.sendSync("resources");
            for (var t in b) if (b.hasOwnProperty(t)) {
                var M = e + "/i18n/" + t + ".json";
                try {
                    if (a.existsSync(M)) {
                        var r = a.readFileSync(M, "utf8"), h = JSON.parse(r), o = w(Z, h),
                            i = JSON.stringify(o, null, "\t");
                        a.writeFileSync(M, i, "utf8"), console.log("Saved bundle for", t)
                    }
                } catch (a) {
    ...
    var E = function a(e, t) {
        ...
        return new Proxy(t, {
            get: function (t, r) {
                return M.hasOwnProperty(r) ? M[r] : M[r] = a(e + k(r) + ".", (function (a, t) {
                    return String.isString(a) ? i18next.t(e + k(r) + "." + a, t) : i18next.t(e + k(r), a)
                }))
            }
        })
    ...
    function B(a, e) {
        if (s(a, e)) {
            ...
            var t = a.relatedTarget;
            if (t && t.matchParent) {
                var M = t.matchParent("[aria-label]");
    ...
    function N(a) {
        ...
        var r = 750;
        a.hasAttribute("data-tooltip-delay") && (r = parseInt(a.getAttribute("data-tooltip-delay") || ""), isNaN(r) && (r = 750)), I(a, e, {
            placement: t,
            classes: M,
            delay: r
        })
    ...
    function I(a, e, t) {
        var M = Date.now(), r = (t = t || {}).placement, h = void 0 === r ? "bottom" : r, o = t.classes,
            i = void 0 === o ? [] : o, l = t.gap, n = void 0 === l ? 8 : l, c = t.horizontalParent, s = t.delay,
            v = void 0 === s ? 0 : s;
        if (v > 0 && (S || M > F + 100)) return O(), t.delay = 0, void (D = window.setTimeout((function () {
            return I(a, e, t)
        }), v));
        if (e) {
            var m = a.doc, p = a.getBoundingClientRect(), u = p.top, d = p.left, f = p.width, g = p.height;
            if (c) {
                var H = c.getBoundingClientRect();
                d = H.left, f = H.width
            }
            S && q === a ? S.setText(e) : (K(), S = createDiv({cls: "tooltip", text: e}));
            var V = S.createDiv("tooltip-arrow"), y = 0, b = 0;
            "bottom" === h ? (y = u + g + n, b = d + f / 2) : "right" === h ? (y = u + g / 2, b = d + f + n, i.push("mod-right")) : "left" === h ? (y = u + g / 2, b = d - n, i.push("mod-left")) : "top" === h && (y = u - n - 5, b = d + f / 2, i.push("mod-top")), S.addClasses(i), S.style.top = "0px", S.style.left = "0px", S.style.width = "", S.style.height = "", S.parentNode || m.body.appendChild(S);
            var L = S.getBoundingClientRect(), C = ["bottom", "top"].contains(h) ? L.width / 2 : L.width,
                w = "right" === h || "left" === h ? L.height / 2 : L.height;
            "left" === h ? b -= C : "top" === h && (y -= w);
            var k = m.body.clientHeight, Z = m.body.clientWidth;
            if (y + w > k && (y = k - w - n), y = Math.max(y, n), "top" === h || "bottom" === h) {
                if (b + C > Z) b -= A = b + C + n - Z, V.style.left = "initial", V.style.right = C - A - n / 2 + "px"; else if (b - n - C < 0) {
                    var A;
                    b += A = -(b - n - C), V.style.right = "initial", V.style.left = C - A - n / 2 + "px"
                }
                b = Math.max(b, n)
            }
            S.style.top = y + "px", S.style.left = b + "px", S.style.width = L.width + "px", S.style.height = L.height + "px", q = a
        }
    }

    function K() {
        O(), S && (F = Date.now(), S.detach(), S = null, q = null)
    }

    function R(a, e) {
        var t = e || {}, M = t.placement, r = t.classes, h = t.delay;
        M && "bottom" !== M && a.setAttribute("data-tooltip-position", M), r && a.setAttribute("data-tooltip-classes", r.join(" ")), h && a.setAttribute("data-tooltip-delay", String(h))
    }

    function U(a, e, t) {
        a.setAttribute("aria-label", e), R(a, t), q === a && I(a, e, t)
    }

    var G = function () {
        function a(a, e) {
            this.eWin = a, this.win = e;
            var t = this.isMac = "darwin" === window.process.platform, M = e.document, r = M.body;
            r.addClass("is-frameless");
            var h = this.titleBarEl = M.createElement("div");
            h.className = "titlebar", r.insertBefore(h, r.firstChild);
            var o = this.titleBarInnerEl = h.createDiv("titlebar-inner");
            this.titleBarTextEl = o.createDiv({
                cls: "titlebar-text",
                text: "Obsidian"
            }), e.addEventListener("resize", this.updateStatus.bind(this)), new MutationObserver(this.updateTitle.bind(this)).observe(document.head.querySelector("title"), {
                subtree: !0,
                characterData: !0,
                childList: !0
            }), this.leftButtonContainerEl = o.createDiv("titlebar-button-container mod-left");
            var i = o.createDiv("titlebar-button-container mod-right");
            if (this.updateStatus(), this.updateTitle(), !t) {
                if (a.minimizable) {
                    ...
                    l.innerHTML = '<svg aria-hidden="false" width="10" height="10" viewBox="0 0 12 12"><rect fill="currentColor" width="10" height="1" x="1" y="6"></rect></svg>', A.then((function () {
                ...
                if (a.maximizable) {
                    var n = i.createDiv({
                        cls: "titlebar-button mod-maximize", onclick: function () {
                            a.isMaximized() ? a.unmaximize() : a.maximize(), c()
                        }
                    });
                ...
                if (a.closable) {
                    ...
                    s.innerHTML = '<svg aria-hidden="false" width="10" height="10" viewBox="0 0 12 12"><polygon fill="currentColor" fill-rule="evenodd" points="11 1.576 6.583 6 11 10.424 10.424 11 6 6.583 1.576 11 1 10.424 5.417 6 1 1.576 1.576 1 6 5.417 10.424 1"></polygon></svg>', A.then((function () {
                ...
                a.addEventListener("dblclick", (function (e) {
                    if (0 === e.button) {
                        ...
                        if (!t.instanceOf(HTMLElement) || !t.closest(".clickable-icon") && !t.closest(".workspace-tab-header-inner-close-button")) {
                            var M = a.win.electronWindow;
                            M.isMaximizable && f((function (a) {
        ...
        return a.prototype.updateTitle = function () {
            ...
            var a = this.win, e = this.eWin;
            if (!a.closed) {
                var t = e.webContents.getZoomFactor(), M = a.document.body;
                if (M.toggleClass("is-fullscreen", e.isFullScreen()), M.toggleClass("is-maximized", e.isMaximized()), M.style.setProperty("--zoom-factor", String(t)), this.isMac && "hidden" === a.titlebarStyle) {
                    var r = 40, h = getComputedStyle(M).getPropertyValue("--header-height");
                    h && (r = parseFloat(h)), (isNaN(r) || 0 === r) && (r = 40);
                    var o = Math.floor(r * t / 2 - 8);
                    o < -5 && (o = 0), e.setTrafficLightPosition({x: o + 2, y: o})
                }
            }
        }, a
    }();
    ...
    function X(a) {
        var e = a[0];
        if (0 === e) return J("line", {x1: a[1], y1: a[2], x2: a[3], y2: a[4]});
        if (1 === e) return J("circle", {cx: a[1], cy: a[2], r: a[3]});
        if (2 === e) return J("polyline", {points: a[1]});
        if (3 === e) return J("polygon", {points: a[1]});
        if (4 === e) return J("ellipse", {cx: a[1], cy: a[2], rx: a[3], ry: a[4]});
        if (5 === e) {
            var t = {x: a[1], y: a[2], width: a[3], height: a[4]};
            return a[5] && (t.rx = a[5]), a[6] && (t.ry = a[6]), a[7] && (t.transform = a[7]), J("rect", t)
        }
        return 6 === e ? J("path", {d: a[1]}) : void 0
    }
    ...
    }, aa = {}, ea = {viewBox: "0 0 100 100"}, ta = {};

    function Ma(a, e) {
        if (!ta.hasOwnProperty(a)) {
            var t = e();
            if (!t) return null;
            t.classList.add("svg-icon", a), ta[a] = t
        }
        return ta[a].cloneNode(!0)
    }
        ...
        if (!(t && t.instanceOf(SVGSVGElement) && t.classList.contains(e))) {
            ...
            var M = function (a) {
                return a.startsWith("lucide-") ? Ma(a, (function () {
                    var e = a.substring("lucide-".length);
                    return W.hasOwnProperty(e) ? Y(W[e]) : null
                })) : aa.hasOwnProperty(a) ? Ma(a, (function () {
                    var e = J("svg", ea);
                    return e.innerHTML = aa[a], e
                })) : $.hasOwnProperty(a) ? Ma(a, (function () {
                    var e = J("svg", _);
                    return e.innerHTML = $[a], e
                })) : (Q.hasOwnProperty(a) && (a = Q[a]), W.hasOwnProperty(a) ? Ma("lucide-" + a, (function () {
                    return Y(W[a])
                })) : null)
            }(e);
            M && a.appendChild(M)
    ...
    var ha = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
    ...
    function ia(a) {
        var e, t, M, r = a.h, h = a.s, o = a.l;
        if (r /= 360, o /= 100, 0 == (h /= 100)) e = t = M = o; else {
            var i = o < .5 ? o * (1 + h) : o + h - o * h, l = 2 * o - i;
            e = oa(l, i, r + 1 / 3), t = oa(l, i, r), M = oa(l, i, r - 1 / 3)
        }
        return {r: Math.round(255 * e), g: Math.round(255 * t), b: Math.round(255 * M)}
    }
    ...
    var ca = function () {
        function a(a) {
            this.components = [];
            var e = this.settingEl = a.createDiv("setting-item"), t = this.infoEl = e.createDiv("setting-item-info");
            this.nameEl = t.createDiv("setting-item-name"), this.descEl = t.createDiv("setting-item-description"), this.controlEl = e.createDiv("setting-item-control")
        }
        ...
        return a.prototype.setName = function (a) {
            ...
            for (var e = 0, t = this.components; e < t.length; e++) {
                t[e].setDisabled(a)
            }
            return this
        ...
        return e(t, a), t.prototype.registerOptionListener = function (a, e) {
            ...
            return a[e] = function (a) {
                return void 0 !== a && t.setValue(a), t.getValue()
            }, this
        }, t
    }(sa), ma = function (a) {
        function t(e) {
            var t = a.call(this) || this;
            return (t.buttonEl = e.createEl("button")).addEventListener("click", (function (a) {
                var e = t.clickCallback;
                !t.disabled && e && e(a)
            })), t
        }
        ...
        function t(e) {
            var t = a.call(this) || this,
                M = t.extraSettingsEl = e.createDiv("clickable-icon setting-editor-extra-setting-button");
            return ra(M, "lucide-settings"), M.addEventListener("click", (function () {
                var a = t.changeCallback;
                !t.disabled && a && a()
            })), t
        }
        ...
        function t(e) {
            var t = a.call(this) || this;
            return t.on = !1, (t.toggleEl = e.createDiv("checkbox-container", (function (a) {
                a.createEl("input", {attr: {type: "checkbox", tabIndex: 0}})
        ...
        return e(t, a), t.prototype.setDisabled = function (e) {
            ...
            var e;
            return this.on = a, this.toggleEl.toggleClass("is-enabled", a), null === (e = this.changeCallback) || void 0 === e || e.call(this, a), this
        ...
        function t(e) {
            return a.call(this, e.createEl("input", {type: "text"})) || this
        }

        return e(t, a), t
    }(da), ga = function (a) {
        function t(e) {
            var t = this, M = e.createDiv("search-input-container"),
                r = M.createEl("input", {type: "search", attr: {enterkeyhint: "search"}});
            return (t = a.call(this, r) || this).containerEl = M, t.clearButtonEl = M.createDiv("search-input-clear-button", (function (a) {
        ...
        function t(e) {
            var t = a.call(this) || this;
            return t.selectEl = e.createEl("select", "dropdown"), t.selectEl.addEventListener("change", (function () {
                var a = t.changeCallback;
                a && a(t.getValue())
            })), t
        }
        ...
        return e(t, a), t.prototype.setDisabled = function (e) {
            ...
            return this.selectEl.createEl("option", {value: a, text: e}), this
        }, t.prototype.addOptions = function (a) {
            for (var e in a) a.hasOwnProperty(e) && this.selectEl.createEl("option", {value: e, text: a[e]});
            return this
        }, t.prototype.getValue = function () {
        ...
        function t(e) {
            var t = a.call(this) || this;
            return t.progressBar = e.createDiv("setting-progress-bar", (function (a) {
        ...
        function t(e) {
            var t = a.call(this) || this;
            t.dynamicTooltip = !1;
            var M = t.sliderEl = e.createEl("input", {type: "range", cls: "slider"});
            return M.addEventListener("input", (function () {
                var a = t.changeCallback;
                a && a(t.getValue()), t.dynamicTooltip && t.showTooltip()
        ...
        return e(t, a), t.prototype.setDisabled = function (e) {
            ...
            return this.sliderEl.setAttrs({min: a, max: e, step: t}), this
        }, t.prototype.getValue = function () {
            ...
            var a = this.sliderEl, e = this.getValue();
            return "any" === a.step || parseFloat(a.step) < 1 ? e.toFixed(2) : e.toString()
        }, t.prototype.setDynamicTooltip = function () {
            var a = this.sliderEl;
            return a.addEventListener("mouseenter", this.showTooltip.bind(this)), a.addEventListener("mouseleave", K), this.dynamicTooltip = !0, this
        }, t.prototype.showTooltip = function () {
            I(this.sliderEl, this.getValuePretty(), {placement: "top"})
        }, t.prototype.onChange = function (a) {
            return this.changeCallback = a, this
        }, t
    }(va), Ca = function (a) {
        function t(e) {
            var t = a.call(this) || this;
            return t.colorPickerEl = e.createEl("input", {type: "color"}), t.colorPickerEl.addEventListener("change", (function () {
                var a = t.changeCallback;
                a && a(t.getValue())
            })), t
        }
        ...
        return e(t, a), t.prototype.setDisabled = function (e) {
            ...
            return na(this.getValue()) || {r: 0, g: 0, b: 0}
        }, t.prototype.getValueHsl = function () {
            return function (a) {
                var e = a.r, t = a.g, M = a.b;
                e /= 255, t /= 255, M /= 255;
                var r, h, o = Math.max(e, t, M), i = Math.min(e, t, M), l = (o + i) / 2;
                if (o == i) r = h = 0; else {
                    var n = o - i;
                    switch (h = l > .5 ? n / (2 - o - i) : n / (o + i), o) {
                        case e:
                            r = (t - M) / n + (t < M ? 6 : 0);
                            break;
                        case t:
                ...
                return {h: Math.round(360 * r), s: Math.round(100 * h), l: Math.round(100 * l)}
            }(this.getValueRgb())
    ...
    for (var za = 0, xa = "address article aside blockquote details dialog dd div dl dt fieldset figcaption figure footer form h1 h2 h3 h4 h5 h6 header hgroup hr li main nav ol p pre ul".split(" "); za < xa.length; za++) {
        Aa = xa[za];
        wa.set(Aa, !1)
    }
    new WeakMap;
    ...
    for (Sa = 65; Sa < 91; Sa++) {
        var qa = String.fromCharCode(Sa);
        Ea[Sa] = qa.toUpperCase()
    }
    for (Sa = 96; Sa < 106; Sa++) Ea[Sa] = "Numpad" + String.fromCharCode(Sa - 48);
    var Da = function () {
        function a(a) {
            this.tabFocusContainerEl = null, this.keys = [], this.parent = a
        }

        return a.prototype.register = function (a, e, t) {
            var M = {scope: this, modifiers: a ? Oa.compileModifiers(a) : null, key: e, func: t};
            ...
            for (var t = 0, M = this.keys; t < M.length; t++) {
                var r = M[t];
                if (Oa.isMatch(r, e)) {
                    var h = r.func(a, e);
        ...
        e(t, a), t.prototype.handleKey = function (e, t) {
            var M = this.cb();
            return M ? M.handleKey(e, t) : a.prototype.handleKey.call(this, e, t)
        }
    }(Da), function () {
        function a() {
            this.modifiers = "", this.rootScope = new Da, this.scope = this.rootScope, this.prevScopes = [], window.addEventListener("keydown", this.onKeyEvent.bind(this), !0), window.addEventListener("focusin", this.onFocusIn.bind(this))
        }
        ...
        return a.init = function () {
            ...
            if (t) {
                ...
                if (!a.isModifierKey(M)) {
                    ...
                    var h = {modifiers: this.modifiers, key: M, vkey: r};
                    return !1 === t.handleKey(e, h) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0
                }
            }
        }, a.prototype.onFocusIn = function (a) {
            var e = this, t = this.scope;
            if (t && t.tabFocusContainerEl) {
                var M = t.tabFocusContainerEl, r = a.targetNode;
                r && r !== activeDocument.body && r.instanceOf(Element) && !M.contains(r) && setTimeout((function () {
                    if (!(e.scope !== t || (h = M.querySelector(["a[href]", "button", "input", "select", "textarea", '[contenteditable]:not([contenteditable="false"])', "[tabindex]"].map((function (a) {
                        return a + ':not([disabled]):not([tabindex="-1"])'
                    })).join(","))) && (h.instanceOf(HTMLElement) || h.instanceOf(SVGElement)) && (h.focus(r), h))) {
            ...
            return a.map((function (a) {
                return "Mod" === a ? "MacOS" === h ? "Meta" : "Ctrl" : a
            })).sort().join(",")
        }, a.decompileModifiers = function (a) {
            return a.split(",").map((function (a) {
                return "MacOS" === h && "Meta" === a || "MacOS" !== h && "Ctrl" === a ? "Mod" : a
            })).filter((function (a) {
                return a
            }))
            ...
            return "Ctrl" === e ? a.ctrlKey : "Meta" === e ? a.metaKey : "Alt" === e ? a.altKey : "Shift" === e ? a.shiftKey : "Mod" === e && ("MacOS" === h ? a.metaKey : a.ctrlKey)
        }, a.isMatch = function (a, e) {
            var t = a.modifiers, M = a.key;
    ...
    !function (a) {
        ...
        if (t) {
            ...
            if (M) {
                ...
                a.open = function (a, e, t) {
                    ...
                    a.titlebarStyle = e, "native" !== e && (a.frameDom = new G(a.electronWindow, a), "hidden" === e && a.document.body.addClass("is-hidden-frameless"))
                }(a)
            }
        }
    }(window), function (a) {
        a || (a = document);
        var e = a.body;
        e.on("mouseover", "[aria-label]", P), e.on("mouseout", "[aria-label]", B), e.addEventListener("mouseup", K)
    }(), function (a) {
        try {
            var e = "";
            i ? e = "mod-macos" : l ? e = "mod-windows" : n && (e = "mod-linux"), e && a.body.addClass(e)
        } catch (a) {
            console.error(a)
        }
    }(document);
            ...
            switch (e.label) {
                ...
                case 1:
                    return e.sent(), a = E.interface.helpScreen, document.title = "Obsidian Help", document.body.addClass("is-focused"), ready((function () {
                        ...
                        var h = M.createDiv("help-options-container"), o = createDiv("setting-icon", (function (a) {
                            ra(a, "lucide-book-open")
                        }));
                        new ca(h).setName(a.labelOfficialHelpSite()).setDesc(a.labelOfficialHelpSiteDesc()).addButton((function (e) {
                            return e.setButtonText(a.actionVisit()).setCta().onClick((function () {
                                electron.shell.openExternal("https://help.obsidian.md/")
                            }))
                        })).settingEl.prepend(o);
                        var i = createDiv("setting-icon", (function (a) {
                            ra(a, "discord")
                        }));
                        new ca(h).setName(a.labelDiscordChat()).setDesc(a.labelDiscordChatDesc()).addButton((function (e) {
                            return e.setButtonText(a.actionJoin()).onClick((function () {
                                electron.shell.openExternal("https://discord.gg/veuWUTm")
                            }))
                        })).settingEl.prepend(i);
                        var l = createDiv("setting-icon", (function (a) {
                            ra(a, "lucide-message-circle")
                        }));
                        new ca(h).setName(a.labelForum()).setDesc(a.labelForumDesc()).addButton((function (e) {
                            return e.setButtonText(a.actionVisit()).onClick((function () {
                                electron.shell.openExternal("https://forum.obsidian.md")
                            }))
                        })).settingEl.prepend(l);
                        var n = createDiv("setting-icon", (function (a) {
                            ra(a, "experiment")
                        }));
                        new ca(h).setName(a.labelSandboxVault()).setDesc(a.labelSandboxVaultDesc()).addButton((function (a) {
                            return a.setButtonText(E.interface.startScreen.buttonOpen()).onClick((function () {
