(() => {
  ...
  let a = (e, t) => (a = Object.setPrototypeOf || {
    __proto__: []
  } instanceof Array && ((a, e) => {
    a.__proto__ = e;
  }) || ((a, e) => {
  ...
  function e(e, t) {
    ...
    a(e, t);
    e.prototype = null === t ? Object.create(t) : (M.prototype = t.prototype, new M());
  }
  function t(a, e, t, M) {
    return new (t || (t = Promise))((r, h) => {
      function o(a) {
        try {
          l(M.next(a));
        } catch (a) {
      ...
      function l(a) {
        let e;
        a.done ? r(a.value) : (e = a.value, e instanceof t ? e : new t(a => {
          a(e);
        })).then(o, i);
      }
      l((M = M.apply(a, e || [])).next());
    });
  }
  function M(a, e) {
    let t;
  ...
  Object.create;
  let r;
  const h = -1 !== (r = navigator.appVersion).indexOf("Win") ? "Windows" : -1 !== r.indexOf("Mac") ? "MacOS" : -1 !== r.indexOf("X11") || -1 !== r.indexOf("Linux") ? "Linux" : "Unknown OS";
  const o = navigator.userAgent.toLowerCase();
  const i = "MacOS" === h;
  const l = "Windows" === h;
  const n = "Linux" === h;
  const c = (o.indexOf("firefox"), /^((?!chrome|android).)*safari/i.test(o));
  /android/i.test(o);
  new WeakMap();
  (() => {
    function a(a) {
      ...
      const e = a || {};
      const t = e.duration;
      const M = undefined === t ? 100 : t;
      const r = e.fn;
      const h = undefined === r ? "ease-in-out" : r;
      this.duration = M;
      this.fn = h;
    }
    a.prototype.addProp = function (a, e, t, M) {
      return undefined === M && (M = null), null !== e && (this.from[a] = e), null !== t && (this.to[a] = t), null !== M && (this.end[a] = M), this;
    };
  })();
  ...
  !(() => {
    ...
    a.prototype.add = function (a, e) {
      ...
      let M = t[a];
      M || (M = [], t[a] = M);
      M.contains(e) || M.push(e);
    };
    a.prototype.remove = function (a, e) {
      const t = this.data;
      const M = t[a];
      M && (M.remove(e), 0 === M.length && delete t[a]);
    };
    ...
    a.prototype.count = function () {
      const a = this.data;
      let e = 0;
      for (const t in a) a.hasOwnProperty(t) && (e += a[t].length);
      return e;
    };
  })();
  (() => {
  ...
  (() => {
    ...
    a.prototype.add = function (a, e) {
      const t = this.data;
      t.has(a) ? t.get(a).add(e) : t.set(a, new Set([e]));
    };
    a.prototype.delete = function (a, e) {
      const t = this.data;
      if (t.has(a)) {
  ...
  function m(a) {
    return v && Date.now() - v.t < 1000 /* 1e3 */ && (Math.abs(a.clientX - v.sx) < 5 && Math.abs(a.clientY - v.sy) < 5 || Math.abs(a.clientX - v.ex) < 5 && Math.abs(a.clientY - v.ey) < 5);
  }
  const p = {
    isDesktop: false,
    isMobile: false,
  ...
  let H = "0.0.0";
  f(a => {
    g = a.ipcRenderer.sendSync("is-dev");
    H = process.versions.electron;
    parseInt(H.split(".")[0]);
    p.resourcePathPrefix = a.ipcRenderer.sendSync("file-url");
  });
  const V = g;
  V || f(a => {
    try {
      a.deprecate.setHandler(() => {});
    } catch (a) {}
  });
  const y = "language";
  ...
  const C = "default";
  function w(a, e) {
    if (String.isString(a)) return null !== e && String.isString(e) ? e : a;
    const t = {};
    for (const M in a) a.hasOwnProperty(M) && (t[M] = w(a[M], e && e[M] || null));
    return t;
  }
  function k(a) {
    return a.replace(/[A-Z]/g, a => "-" + a.toLowerCase()).replace(/_[0-9]/g, a => "-" + a.substring(1));
  }
  i18next.init({
    fallbackLng: "en",
    ns: [C],
  ...
  const Z = function a(e, t) {
    const M = {};
    for (const r in e) if (e.hasOwnProperty(r)) {
      const h = t(r);
      const o = e[r];
      String.isString(o) ? M[h] = o : M[h] = a(o, t);
    }
    return M;
  }(OBSIDIAN_DEFAULT_I18N, k);
  i18next.addResourceBundle("en", C, Z);
  let A = Promise.resolve();
  const z = localStorage.getItem(y);
  if (z) {
    A = t(undefined, undefined, undefined, function () {
      let a;
      let e;
      let t;
      let r;
      ...
      return M(this, M => {
        switch (M.label) {
          case 0:
            return M.trys.push([0, 5,, 6]), z.contains("/") || z.contains("\\") ? (a = JSON.parse(window.require("original-fs").readFileSync(z, "utf8")), i18next.addResourceBundle("dev", C, a), [4, i18next.changeLanguage("dev")]) : [3, 2];
          case 1:
            return M.sent(), [2];
          case 2:
            return r = (t = JSON).parse, [4, ajaxPromise({
              url: "/i18n/" + z + ".json"
            })];
          case 3:
            return e = r.apply(t, [M.sent()]), i18next.addResourceBundle(z, C, e), [4, i18next.changeLanguage(z)];
          case 4:
            return M.sent(), [3, 6];
          case 5:
            return h = M.sent(), console.error("Failed to load language pack.", h), [3, 6];
          case 6:
            return [2];
        }
      });
    ...
    try {
      let x = z.toLowerCase();
      L.hasOwnProperty(x) && (x = L[x]);
      window.moment.locale(x);
    } catch (a) {}
  }
  window.selectLanguageFileLocation = () => {
    if (p.isDesktopApp) {
      const a = electron.remote.dialog.showOpenDialogSync({
  ...
  V && (window.i18nGenBundles = () => {
    if (p.isDesktopApp) {
      const a = window.require("original-fs");
      const e = electron.ipcRenderer.sendSync("resources");
      for (const t in b) if (b.hasOwnProperty(t)) {
        const M = e + "/i18n/" + t + ".json";
        try {
          if (a.existsSync(M)) {
            const r = a.readFileSync(M, "utf8");
            const h = JSON.parse(r);
            const o = w(Z, h);
            const i = JSON.stringify(o, null, "\t");
            a.writeFileSync(M, i, "utf8");
            console.log("Saved bundle for", t);
          }
        } catch (a) {
          console.error("Failed to process translation for", t, a);
        }
      }
    }
  });
  const E = function a(e, t) {
    const M = {};
    return new Proxy(t, {
      get: function (t, r) {
        return M.hasOwnProperty(r) ? M[r] : M[r] = a(e + k(r) + ".", (a, t) => String.isString(a) ? i18next.t(e + k(r) + "." + a, t) : i18next.t(e + k(r), a));
      }
    });
  ...
  function B(a, e) {
    if (s(a, e)) {
      ...
      const t = a.relatedTarget;
      if (t && t.matchParent) {
        const M = t.matchParent("[aria-label]");
  ...
  function N(a) {
    O();
    let e = a.getAttribute("aria-label") || "";
    j.has(a) && (e = j.get(a)(a));
    let t = "bottom";
    a.hasAttribute("data-tooltip-position") && (t = a.getAttribute("data-tooltip-position"));
    let M = [];
    a.hasAttribute("data-tooltip-classes") && (M = (a.getAttribute("data-tooltip-classes") || "").split(" "));
    let r = 750;
    a.hasAttribute("data-tooltip-delay") && (r = parseInt(a.getAttribute("data-tooltip-delay") || ""), isNaN(r) && (r = 750));
    I(a, e, {
      placement: t,
      classes: M,
      delay: r
  ...
  function I(a, e, t) {
    const M = Date.now();
    const r = (t = t || {}).placement;
    const h = undefined === r ? "bottom" : r;
    const o = t.classes;
    const i = undefined === o ? [] : o;
    const l = t.gap;
    const n = undefined === l ? 8 : l;
    const c = t.horizontalParent;
    const s = t.delay;
    const v = undefined === s ? 0 : s;
    if (v > 0 && (S || M > F + 100)) return O(), t.delay = 0, void (D = window.setTimeout(() => I(a, e, t), v));
    if (e) {
      const m = a.doc;
      ...
      S && q === a ? S.setText(e) : (K(), S = createDiv({
        cls: "tooltip",
        text: e
      }));
      const V = S.createDiv("tooltip-arrow");
      let y = 0;
      let b = 0;
      "bottom" === h ? (y = u + g + n, b = d + f / 2) : "right" === h ? (y = u + g / 2, b = d + f + n, i.push("mod-right")) : "left" === h ? (y = u + g / 2, b = d - n, i.push("mod-left")) : "top" === h && (y = u - n - 5, b = d + f / 2, i.push("mod-top"));
      S.addClasses(i);
      S.style.top = "0px";
      S.style.left = "0px";
      S.style.width = "";
      S.style.height = "";
      S.parentNode || m.body.appendChild(S);
      const L = S.getBoundingClientRect();
      const C = ["bottom", "top"].contains(h) ? L.width / 2 : L.width;
      const w = "right" === h || "left" === h ? L.height / 2 : L.height;
      "left" === h ? b -= C : "top" === h && (y -= w);
      const k = m.body.clientHeight;
      const Z = m.body.clientWidth;
      if (y + w > k && (y = k - w - n), y = Math.max(y, n), "top" === h || "bottom" === h) {
        if (b + C > Z) {
          b -= A = b + C + n - Z;
          V.style.left = "initial";
          V.style.right = C - A - n / 2 + "px";
        } else if (b - n - C < 0) {
          var A;
          b += A = -(b - n - C);
          V.style.right = "initial";
          V.style.left = C - A - n / 2 + "px";
        }
        b = Math.max(b, n);
      }
      S.style.top = y + "px";
  ...
  function K() {
    O();
    S && (F = Date.now(), S.detach(), S = null, q = null);
  }
  function R(a, e) {
    const t = e || {};
    const M = t.placement;
    const r = t.classes;
    const h = t.delay;
    M && "bottom" !== M && a.setAttribute("data-tooltip-position", M);
    r && a.setAttribute("data-tooltip-classes", r.join(" "));
    h && a.setAttribute("data-tooltip-delay", String(h));
  }
  function U(a, e, t) {
  ...
  const G = (() => {
    function a(a, e) {
      this.eWin = a;
      this.win = e;
      const t = this.isMac = "darwin" === window.process.platform;
      const M = e.document;
      const r = M.body;
      r.addClass("is-frameless");
      const h = this.titleBarEl = M.createElement("div");
      h.className = "titlebar";
      r.insertBefore(h, r.firstChild);
      const o = this.titleBarInnerEl = h.createDiv("titlebar-inner");
      this.titleBarTextEl = o.createDiv({
        cls: "titlebar-text",
        text: "Obsidian"
      });
      e.addEventListener("resize", this.updateStatus.bind(this));
      new MutationObserver(this.updateTitle.bind(this)).observe(document.head.querySelector("title"), {
        subtree: true,
        characterData: true,
        childList: true
      });
      this.leftButtonContainerEl = o.createDiv("titlebar-button-container mod-left");
      const i = o.createDiv("titlebar-button-container mod-right");
      if (this.updateStatus(), this.updateTitle(), !t) {
        if (a.minimizable) {
          ...
          l.innerHTML = '<svg aria-hidden="false" width="10" height="10" viewBox="0 0 12 12"><rect fill="currentColor" width="10" height="1" x="1" y="6"></rect></svg>';
          A.then(() => {
            U(l, E.interface.window.minimize());
          });
        }
        if (a.maximizable) {
          const n = i.createDiv({
          ...
          n.innerHTML = '<svg aria-hidden="false" width="10" height="10" viewBox="0 0 12 12"><rect width="9" height="9" x="1.5" y="1.5" fill="none" stroke="currentColor"></rect></svg>';
          var c = () => {
            e.closed || (a.isMaximized() ? U(n, E.interface.window.restoreDown()) : U(n, E.interface.window.maximize()));
          };
          A.then(() => {
            c();
          });
        ...
        if (a.closable) {
          ...
          s.innerHTML = '<svg aria-hidden="false" width="10" height="10" viewBox="0 0 12 12"><polygon fill="currentColor" fill-rule="evenodd" points="11 1.576 6.583 6 11 10.424 10.424 11 6 6.583 1.576 11 1 10.424 5.417 6 1 1.576 1.576 1 6 5.417 10.424 1"></polygon></svg>';
          A.then(() => {
            U(s, E.interface.window.closeWindow());
          });
        }
      }
      !(a => {
        ...
        a.addEventListener("dblclick", e => {
          if (0 === e.button) {
            const t = e.target;
            if (!t.instanceOf(HTMLElement) || !t.closest(".clickable-icon") && !t.closest(".workspace-tab-header-inner-close-button")) {
              const M = a.win.electronWindow;
              M.isMaximizable && f(a => {
                const e = a.remote.systemPreferences.getUserDefault("AppleActionOnDoubleClick", "string");
                "Minimize" === e ? M.minimize() : "Maximize" !== e && "" !== e || (M.isMaximized() ? M.unmaximize() : M.maximize());
              });
            }
          }
        });
    ...
    return a.prototype.updateTitle = function () {
      ...
      const e = this.eWin;
      if (!a.closed) {
        const t = e.webContents.getZoomFactor();
        const M = a.document.body;
        if (M.toggleClass("is-fullscreen", e.isFullScreen()), M.toggleClass("is-maximized", e.isMaximized()), M.style.setProperty("--zoom-factor", String(t)), this.isMac && "hidden" === a.titlebarStyle) {
          let r = 40;
          const h = getComputedStyle(M).getPropertyValue("--header-height");
          h && (r = parseFloat(h));
          (isNaN(r) || 0 === r) && (r = 40);
          let o = Math.floor(r * t / 2 - 8);
          o < -5 && (o = 0);
          e.setTrafficLightPosition({
            x: o + 2,
            y: o
          });
        }
  ...
  const W = {
    ...
    "key-round": [[6, "M2 18v3c0 .6.4 1 1 1h4v-3h3v-3h2l1.4-1.4a6.5 6.5 0 1 0-4-4Z"], [1, 16.5, 7.5, 0.5 /* .5 */]],
    ...
    palette: [[1, 13.5, 6.5, 0.5 /* .5 */], [1, 17.5, 10.5, 0.5 /* .5 */], [1, 8.5, 7.5, 0.5 /* .5 */], [1, 6.5, 12.5, 0.5 /* .5 */], [6, "M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"]],
    ...
    "scatter-chart": [[1, 7.5, 7.5, 0.5 /* .5 */], [1, 18.5, 5.5, 0.5 /* .5 */], [1, 11.5, 11.5, 0.5 /* .5 */], [1, 7.5, 16.5, 0.5 /* .5 */], [1, 17.5, 14.5, 0.5 /* .5 */], [6, "M3 3v18h18"]],
    ...
    tractor: [[6, "M3 4h9l1 7"], [6, "M4 11V4"], [6, "M8 10V4"], [6, "M18 5c-.6 0-1 .4-1 1v5.6"], [6, "m10 11 11 .9c.6 0 .9.5.8 1.1l-.8 5h-1"], [1, 7, 15, 0.5 /* .5 */], [1, 7, 15, 5], [6, "M16 18h-5"], [1, 18, 18, 2]],
  ...
  function J(a, e) {
    const t = document.createElementNS("http://www.w3.org/2000/svg", a);
  ...
  function X(a) {
    const e = a[0];
    if (0 === e) return J("line", {
      x1: a[1],
      y1: a[2],
      x2: a[3],
      y2: a[4]
    });
    if (1 === e) return J("circle", {
      cx: a[1],
      cy: a[2],
      r: a[3]
    });
    if (2 === e) return J("polyline", {
      points: a[1]
    });
    if (3 === e) return J("polygon", {
      points: a[1]
    });
    if (4 === e) return J("ellipse", {
      cx: a[1],
      cy: a[2],
      rx: a[3],
      ry: a[4]
    ...
    if (5 === e) {
      ...
      return a[5] && (t.rx = a[5]), a[6] && (t.ry = a[6]), a[7] && (t.transform = a[7]), J("rect", t);
    }
    return 6 === e ? J("path", {
      d: a[1]
    }) : undefined;
  ...
  function Y(a) {
    for (var e = J("svg", _), t = 0, M = a; t < M.length; t++) {
      const r = M[t];
      e.appendChild(X(r));
    }
    return e;
  ...
  function Ma(a, e) {
    if (!ta.hasOwnProperty(a)) {
      const t = e();
      if (!t) return null;
      t.classList.add("svg-icon", a);
      ta[a] = t;
    }
    return ta[a].cloneNode(true);
  }
  function ra(a, e) {
    const t = a.firstChild;
    if (!(t && t.instanceOf(SVGSVGElement) && t.classList.contains(e))) {
      t && a.removeChild(t);
      const M = (a => a.startsWith("lucide-") ? Ma(a, () => {
        const e = a.substring("lucide-".length);
        return W.hasOwnProperty(e) ? Y(W[e]) : null;
      }) : aa.hasOwnProperty(a) ? Ma(a, () => {
        const e = J("svg", ea);
        return e.innerHTML = aa[a], e;
      }) : $.hasOwnProperty(a) ? Ma(a, () => {
        const e = J("svg", _);
        return e.innerHTML = $[a], e;
      }) : (Q.hasOwnProperty(a) && (a = Q[a]), W.hasOwnProperty(a) ? Ma("lucide-" + a, () => Y(W[a])) : null))(e);
      M && a.appendChild(M);
    }
  }
  const ha = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i;
  function oa(a, e, t) {
    return t < 0 && (t += 1), t > 1 && (t -= 1), t < 1 / 6 ? a + 6 * (e - a) * t : t < 0.5 /* .5 */ ? e : t < 2 / 3 ? a + (e - a) * (2 / 3 - t) * 6 : a;
  }
  function ia(a) {
    let e;
    let t;
    ...
    let h = a.s;
    let o = a.l;
    if (r /= 360, o /= 100, 0 == (h /= 100)) e = t = M = o;else {
      const i = o < 0.5 /* .5 */ ? o * (1 + h) : o + h - o * h;
      const l = 2 * o - i;
      e = oa(l, i, r + 1 / 3);
      t = oa(l, i, r);
      M = oa(l, i, r - 1 / 3);
  ...
  const ca = (() => {
      function a(a) {
        this.components = [];
        const e = this.settingEl = a.createDiv("setting-item"), t = this.infoEl = e.createDiv("setting-item-info");
        this.nameEl = t.createDiv("setting-item-name");
        this.descEl = t.createDiv("setting-item-description");
        this.controlEl = e.createDiv("setting-item-control");
      }
      return a.prototype.setName = function (a) {
        ...
        return this.settingEl.addClass(a), this;
      }, a.prototype.setTooltip = function (a, e) {
        return U(this.nameEl, a, e), this;
        ...
        this.settingEl.toggleClass("is-disabled", a);
        for (let e = 0, t = this.components; e < t.length; e++) {
          t[e].setDisabled(a);
        }
        return this;
  ...
  const va = (a => {
    function t(...args) {
      return null !== a && a.apply(this, args) || this;
    }
    return e(t, a), t.prototype.registerOptionListener = function (a, e) {
      const t = this;
      return a[e] = a => (undefined !== a && t.setValue(a), t.getValue()), this;
    }, t;
  })(sa);

  var ma = (a => {
    function t(e) {
      const t = a.call(this) || this;
      return (t.buttonEl = e.createEl("button")).addEventListener("click", a => {
        const e = t.clickCallback;
        !t.disabled && e && e(a);
      }), t;
    }
    return e(t, a), t.prototype.setDisabled = function (e) {
    ...
    }, t.prototype.setTooltip = function (a, e) {
      return U(this.buttonEl, a, e), this;
    }, t.prototype.setButtonText = function (a) {
      return this.buttonEl.setText(a), this;
    }, t.prototype.setIcon = function (a) {
      return ra(this.buttonEl, a), this;
    }, t.prototype.setClass = function (a) {
      return this.buttonEl.addClass(a), this;
    }, t.prototype.onClick = function (a) {
  ...
  var pa = (a => {
    function t(e) {
      const t = a.call(this) || this, M = t.extraSettingsEl = e.createDiv("clickable-icon setting-editor-extra-setting-button");
      return ra(M, "lucide-settings"), M.addEventListener("click", () => {
        const a = t.changeCallback;
        !t.disabled && a && a();
      }), t;
    }
    return e(t, a), t.prototype.setDisabled = function (e) {
      return a.prototype.setDisabled.call(this, e), this.extraSettingsEl.toggleClass("is-disabled", e), this;
    }, t.prototype.setTooltip = function (a, e) {
      return U(this.extraSettingsEl, a, e), this;
    }, t.prototype.setIcon = function (a) {
      return ra(this.extraSettingsEl, a), this;
    }, t.prototype.onClick = function (a) {
  ...
  var ua = (a => {
    function t(e) {
      const t = a.call(this) || this;
      return t.on = false, (t.toggleEl = e.createDiv("checkbox-container", a => {
        a.createEl("input", {
          attr: {
            type: "checkbox",
            tabIndex: 0
      ...
      })).addEventListener("click", t.onClick.bind(t)), t;
    }
    return e(t, a), t.prototype.setDisabled = function (e) {
      ...
      let e;
      return this.on = a, this.toggleEl.toggleClass("is-enabled", a), null === (e = this.changeCallback) || undefined === e || e.call(this, a), this;
    }, t.prototype.setSmall = function () {
      return this.toggleEl.addClass("mod-small"), this;
    }, t.prototype.setTooltip = function (a, e) {
      return U(this.toggleEl, a, e), this;
    }, t.prototype.onClick = function () {
      this.disabled || this.setValue(!this.getValue());
    }, t.prototype.onChange = function (a) {
      return this.changeCallback = a, this;
    }, t;
  })(va);
  ...
  const da = (a => {
    function t(e) {
      const t = a.call(this) || this;
      return t.inputEl = e, e.addEventListener("input", t.onChanged.bind(t)), e.setAttribute("spellcheck", "false"), t;
    }
    return e(t, a), t.prototype.setDisabled = function (e) {
  ...
  var fa = (a => {
    function t(e) {
      return a.call(this, e.createEl("input", {
        type: "text"
      })) || this;
    }
    return e(t, a), t;
  ...
  var ga = (a => {
    function t(e) {
      let t = this;
      const M = e.createDiv("search-input-container");

      const r = M.createEl("input", {
        type: "search",
        attr: {
          enterkeyhint: "search"
        }
      ...
      return (t = a.call(this, r) || this).containerEl = M, t.clearButtonEl = M.createDiv("search-input-clear-button", a => {
        a.addEventListener("click", () => {
          t.disabled || (r.value = "", r.focus(), t.onChanged());
        });
      }), t;
    }
    return e(t, a), t.prototype.onChanged = function () {
      a.prototype.onChanged.call(this);
    }, t.prototype.setValue = function (e) {
      return a.prototype.setValue.call(this, e);
    }, t.prototype.setClass = function (a) {
      return this.containerEl.addClass(a), this;
    }, t.prototype.addRightDecorator = function (a) {
  ...
  var Va = (a => {
    ...
    return e(t, a), t.prototype.setDefaultFormat = function (a) {
      return this.defaultFormat = a, this.setPlaceholder(a), this.updateSample(), this;
    }, t.prototype.setSampleEl = function (a) {
      ...
      const a = this.sampleEl;
      if (a) {
        const e = this.inputEl.value || this.defaultFormat;
        if (e) {
          const t = window.moment().format(e);
          a.setText(t);
        } else a.setText("");
      }
    }, t;
  ...
  var ya = (a => {
    function t(e) {
      const t = a.call(this) || this;
      return t.selectEl = e.createEl("select", "dropdown"), t.selectEl.addEventListener("change", () => {
        const a = t.changeCallback;
        a && a(t.getValue());
      }), t;
    }
    return e(t, a), t.prototype.setDisabled = function (e) {
    ...
    }, t.prototype.addOption = function (a, e) {
      return this.selectEl.createEl("option", {
        value: a,
        text: e
      }), this;
    }, t.prototype.addOptions = function (a) {
      for (const e in a) a.hasOwnProperty(e) && this.selectEl.createEl("option", {
        value: e,
        text: a[e]
      });
      return this;
      ...
      return this.selectEl.value = a, this;
    }, t.prototype.onChange = function (a) {
      return this.changeCallback = a, this;
    }, t;
  })(va);
  ...
  var ba = (a => {
    function t(e) {
      const t = a.call(this) || this;
      return t.progressBar = e.createDiv("setting-progress-bar", a => {
        t.lineEl = a.createDiv("setting-progress-bar-inner");
      }), t;
    }
    return e(t, a), t.prototype.getValue = function () {
      return this.value;
    }, t.prototype.setValue = function (a) {
  ...
  var La = (a => {
    function t(e) {
      const t = a.call(this) || this;
      t.dynamicTooltip = false;
      const M = t.sliderEl = e.createEl("input", {
        type: "range",
        cls: "slider"
      });
      return M.addEventListener("input", () => {
        const a = t.changeCallback;
        a && a(t.getValue());
        t.dynamicTooltip && t.showTooltip();
    ...
    return e(t, a), t.prototype.setDisabled = function (e) {
    ...
    }, t.prototype.setLimits = function (a, e, t) {
      ...
      this.sliderEl.valueAsNumber = a;
      const e = this.changeCallback;
      return e && e(a), this;
    }, t.prototype.getValuePretty = function () {
      const a = this.sliderEl, e = this.getValue();
      return "any" === a.step || parseFloat(a.step) < 1 ? e.toFixed(2) : e.toString();
    }, t.prototype.setDynamicTooltip = function () {
      const a = this.sliderEl;
      return a.addEventListener("mouseenter", this.showTooltip.bind(this)), a.addEventListener("mouseleave", K), this.dynamicTooltip = true, this;
    }, t.prototype.showTooltip = function () {
      I(this.sliderEl, this.getValuePretty(), {
        placement: "top"
      });
    }, t.prototype.onChange = function (a) {
      return this.changeCallback = a, this;
  ...
  var Ca = (a => {
    function t(e) {
      const t = a.call(this) || this;
      return t.colorPickerEl = e.createEl("input", {
        type: "color"
      }), t.colorPickerEl.addEventListener("change", () => {
        const a = t.changeCallback;
        a && a(t.getValue());
      }), t;
    }
    return e(t, a), t.prototype.setDisabled = function (e) {
      ...
      return (a => {
        let e = a.r, t = a.g, M = a.b;
        e /= 255;
        t /= 255;
        M /= 255;
        let r;
        let h;
        const o = Math.max(e, t, M);
        const i = Math.min(e, t, M);
        const l = (o + i) / 2;
        if (o == i) r = h = 0;else {
          const n = o - i;
          switch (h = l > 0.5 /* .5 */ ? n / (2 - o - i) : n / (o + i), o) {
            case e:
              r = (t - M) / n + (t < M ? 6 : 0);
              break;
            case t:
      ...
      const e = this.changeCallback;
      return e && e(this.getValue()), this;
    }, t.prototype.setValueRgb = function (a) {
      return this.setValue((a => {
        const e = a.r, t = a.g, M = a.b;
        return "#" + la(e) + la(t) + la(M);
      })(a));
    }, t.prototype.setValueHsl = function (a) {
      return this.setValueRgb(ia(a));
    }, t.prototype.setValueInt = function (a) {
  ...
  for (var wa = new Map(), ka = 0, Za = "a abbr acronym b bdi bdo big br button canvas cite code data del dfn em embed i iframe img input ins kbd label map mark meter noscript object outputpicture progress q ruby s samp select small span strong sub sup svg textarea time u tt var video wbr".split(" "); ka < Za.length; ka++) {
    var Aa = Za[ka];
    wa.set(Aa, true);
  }
  for (let za = 0, xa = "address article aside blockquote details dialog dd div dl dt fieldset figcaption figure footer form h1 h2 h3 h4 h5 h6 header hgroup hr li main nav ol p pre ul".split(" "); za < xa.length; za++) {
    Aa = xa[za];
    wa.set(Aa, false);
  }
  new WeakMap();
  ...
  for (var Ea = {
      ...
      250: "Play",
      251: "ZoomOut"
    }, Sa = 1; Sa < 25; Sa++) Ea[111 + Sa] = "F" + Sa;
  for (Sa = 65; Sa < 91; Sa++) {
    const qa = String.fromCharCode(Sa);
    Ea[Sa] = qa.toUpperCase();
  }
  for (Sa = 96; Sa < 106; Sa++) Ea[Sa] = "Numpad" + String.fromCharCode(Sa - 48);
  ...
  const Da = (() => {
      ...
      return a.prototype.register = function (a, e, t) {
        const M = {
          scope: this,
          modifiers: a ? Oa.compileModifiers(a) : null,
          key: e,
          func: t
        };
        return this.keys.push(M), M;
        ...
        for (let t = 0, M = this.keys; t < M.length; t++) {
          const r = M[t];
          if (Oa.isMatch(r, e)) {
            const h = r.func(a, e);
            if (undefined !== h) return h;
            if (null !== r.key || null !== r.modifiers) return h;
          }
        }
  ...
  var Oa = ((a => {
    class t {
      constructor(e, t) {
        const M = a.call(this, e) || this;
        return M.cb = t, M;
      }

      handleKey(e, t) {
        const M = this.cb();
        return M ? M.handleKey(e, t) : a.prototype.handleKey.call(this, e, t);
      }
    }
    ...
    class a {
      ...
      static open(a, e, t) {
        return "string" == typeof a && 0 === a.indexOf("file:") ? (M.ipcRenderer.send("open-url", a), null) : r.apply(this, arguments);
      }
    }

    return a.init = () => (a.global || (a.global = new a()), a.global), a.prototype.getRootScope = function () {
      return this.rootScope;
    }, a.prototype.pushScope = function (a) {
      this.scope !== a && (this.prevScopes.push(this.scope), this.scope = a);
    }, a.prototype.popScope = function (a) {
      a !== this.rootScope && (this.scope === a ? this.scope = this.prevScopes.pop() || this.rootScope : this.prevScopes.remove(a));
      ...
      if (t) {
        const M = (a => {
          let e = a.key;
          if (!e) {
            const t = a.which || a.keyCode;
            e = Ea[t];
          }
          return e;
        })(e);
        if (!a.isModifierKey(M)) {
          let r = (a => {
            const e = a.which || a.keyCode;
            return Ea[e] || "Key" + e;
          })(e);
          54 === e.which && "^" == e.key && "KeyI" === e.code && (r = "KeyI");
          const h = {
            modifiers: this.modifiers,
            key: M,
            vkey: r
          };
          return false === t.handleKey(e, h) ? (e.preventDefault(), e.stopPropagation(), false) : undefined;
        }
      }
    }, a.prototype.onFocusIn = function (a) {
      const e = this, t = this.scope;
      if (t && t.tabFocusContainerEl) {
        const M = t.tabFocusContainerEl, r = a.targetNode;
        r && r !== activeDocument.body && r.instanceOf(Element) && !M.contains(r) && setTimeout(() => {
          if (!(e.scope !== t || (h = M.querySelector(["a[href]", "button", "input", "select", "textarea", '[contenteditable]:not([contenteditable="false"])', "[tabindex]"].map(a => a + ':not([disabled]):not([tabindex="-1"])').join(","))) && (h.instanceOf(HTMLElement) || h.instanceOf(SVGElement)) && (h.focus(r), h))) {
      ...
      const t = [];
      return e.ctrlKey && t.push("Ctrl"), e.metaKey && t.push("Meta"), e.altKey && t.push("Alt"), e.shiftKey && t.push("Shift"), a.compileModifiers(t);
    }, a.compileModifiers = a => a.map(a => "Mod" === a ? "MacOS" === h ? "Meta" : "Ctrl" : a).sort().join(","), a.decompileModifiers = a => a.split(",").map(a => "MacOS" === h && "Meta" === a || "MacOS" !== h && "Ctrl" === a ? "Mod" : a).filter(a => a), a.isModifierKey = a => "Control" === a || "Alt" === a || "Shift" === a || "OS" === a || "Meta" === a, a.prototype.matchModifiers = function (a) {
      return this.modifiers === a;
    }, a.prototype.hasModifier = function (e) {
      return a.decompileModifiers(this.modifiers).contains(e);
    }, a.isModifier = (a, e) => "Ctrl" === e ? a.ctrlKey : "Meta" === e ? a.metaKey : "Alt" === e ? a.altKey : "Shift" === e ? a.shiftKey : "Mod" === e && ("MacOS" === h ? a.metaKey : a.ctrlKey), a.isMatch = (a, e) => {
      const t = a.modifiers, M = a.key;
      return (null === t || t === e.modifiers) && (!M || M === e.vkey || !(!e.key || M.toLowerCase() !== e.key.toLowerCase()));
    }, a.isModEvent = e => !!e && ((a => (a.instanceOf(MouseEvent) || a.instanceOf(PointerEvent)) && 1 === a.button)(e) ? "tab" : !!a.isModifier(e, "Mod") && (a.isModifier(e, "Alt") ? a.isModifier(e, "Shift") ? "window" : "split" : "tab")), a;
  })());
  ...
  !(a => {
    ...
    if (t) {
      const M = t("electron");
      if (M) {
        if (a.electron = M, !M.remote) try {
          M.remote = t("@electron/remote");
        } catch (a) {
          console.error(a);
        }
        a.electronWindow = M.remote.getCurrentWindow();
        const r = a.open;
        a.parent === a && (a => {
          const e = a.electron.ipcRenderer.sendSync("frame") || "hidden";
          a.titlebarStyle = e;
          "native" !== e && (a.frameDom = new G(a.electronWindow, a), "hidden" === e && a.document.body.addClass("is-hidden-frameless"));
        })(a);
      }
    }
  })(window);
  (a => {
    a || (a = document);
    const e = a.body;
    e.on("mouseover", "[aria-label]", P);
    e.on("mouseout", "[aria-label]", B);
    e.addEventListener("mouseup", K);
  })();
  (a => {
    try {
      let e = "";
      i ? e = "mod-macos" : l ? e = "mod-windows" : n && (e = "mod-linux");
      e && a.body.addClass(e);
    } catch (a) {
      console.error(a);
    }
  ...
  t(undefined, undefined, undefined, function () {
    let a;
    return M(this, e => {
      switch (e.label) {
        case 0:
        ...
        case 1:
          return e.sent(), a = E.interface.helpScreen, document.title = "Obsidian Help", document.body.addClass("is-focused"), ready(() => {
            ...
            r.createDiv({
              ...
              text: "".concat(E.interface.startScreen.labelVersion(), " ").concat(electron.ipcRenderer.sendSync("version"))
            });
            const h = M.createDiv("help-options-container");

            const o = createDiv("setting-icon", a => {
              ra(a, "lucide-book-open");
            });

            new ca(h).setName(a.labelOfficialHelpSite()).setDesc(a.labelOfficialHelpSiteDesc()).addButton(e => e.setButtonText(a.actionVisit()).setCta().onClick(() => {
              electron.shell.openExternal("https://help.obsidian.md/");
            })).settingEl.prepend(o);
            const i = createDiv("setting-icon", a => {
              ra(a, "discord");
            });
            new ca(h).setName(a.labelDiscordChat()).setDesc(a.labelDiscordChatDesc()).addButton(e => e.setButtonText(a.actionJoin()).onClick(() => {
              electron.shell.openExternal("https://discord.gg/veuWUTm");
            })).settingEl.prepend(i);
            const l = createDiv("setting-icon", a => {
              ra(a, "lucide-message-circle");
            });
            new ca(h).setName(a.labelForum()).setDesc(a.labelForumDesc()).addButton(e => e.setButtonText(a.actionVisit()).onClick(() => {
              electron.shell.openExternal("https://forum.obsidian.md");
            })).settingEl.prepend(l);
            const n = createDiv("setting-icon", a => {
              ra(a, "experiment");
            });
            new ca(h).setName(a.labelSandboxVault()).setDesc(a.labelSandboxVaultDesc()).addButton(a => a.setButtonText(E.interface.startScreen.buttonOpen()).onClick(() => {
